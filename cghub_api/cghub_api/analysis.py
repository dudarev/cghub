...
# Generated 2012-06-05 14:51:00.641370 by PyXB version 1.1.3
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b8514fe2-af04-11e1-9520-0026c7825912')
...
STD_ANON.bai = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'bai', tag=u'bai')
STD_ANON.vcf = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'vcf', tag=u'vcf')
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    __accession = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'accession'), 'accession', '__AbsentNamespace0_CTD_ANON__accession', pyxb.binding.datatypes.string)
    ...
    __refname = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'refname'), 'refname', '__AbsentNamespace0_CTD_ANON__refname', pyxb.binding.datatypes.string)
    ...
    __label = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'label'), 'label', '__AbsentNamespace0_CTD_ANON__label', pyxb.binding.datatypes.string)
    ...
    __refcenter = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'refcenter'), 'refcenter', '__AbsentNamespace0_CTD_ANON__refcenter', pyxb.binding.datatypes.string)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ANALYSIS_LINK = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ANALYSIS_LINK'), 'ANALYSIS_LINK', '__AbsentNamespace0_CTD_ANON_2_ANALYSIS_LINK', True)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __SEQUENCE_VARIATION = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'SEQUENCE_VARIATION'), 'SEQUENCE_VARIATION', '__AbsentNamespace0_CTD_ANON_3_SEQUENCE_VARIATION', False)
    ...
    __SEQUENCE_ANNOTATION = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'SEQUENCE_ANNOTATION'), 'SEQUENCE_ANNOTATION', '__AbsentNamespace0_CTD_ANON_3_SEQUENCE_ANNOTATION', False)
    ...
    __REFERENCE_ALIGNMENT = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'REFERENCE_ALIGNMENT'), 'REFERENCE_ALIGNMENT', '__AbsentNamespace0_CTD_ANON_3_REFERENCE_ALIGNMENT', False)
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ANALYSIS_ATTRIBUTE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ANALYSIS_ATTRIBUTE'), 'ANALYSIS_ATTRIBUTE', '__AbsentNamespace0_CTD_ANON_7_ANALYSIS_ATTRIBUTE', True)
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute alias uses Python identifier alias
    __alias = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'alias'), 'alias', '__AbsentNamespace0_CTD_ANON_8_alias', pyxb.binding.datatypes.string)
    
    alias = property(__alias.value, __alias.set, None, u'\n                    Submitter designated name of the SRA document of this type.  At minimum alias should\n                    be unique throughout the submission of this document type.  If center_name is specified, the name should\n                    be unique in all submissions from that center of this document type.\n                ')

    
    # Attribute accession uses Python identifier accession
    __accession = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'accession'), 'accession', '__AbsentNamespace0_CTD_ANON_8_accession', pyxb.binding.datatypes.string)
    
    accession = property(__accession.value, __accession.set, None, u"\n                    The document's accession as assigned by the Home Archive.\n                ")

    
    # Attribute broker_name uses Python identifier broker_name
    __broker_name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'broker_name'), 'broker_name', '__AbsentNamespace0_CTD_ANON_8_broker_name', pyxb.binding.datatypes.string)
    
    broker_name = property(__broker_name.value, __broker_name.set, None, u'\n                    Broker authority of this document.  If not provided, then the broker is considered "direct".\n                ')

    
    # Attribute center_name uses Python identifier center_name
    __center_name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'center_name'), 'center_name', '__AbsentNamespace0_CTD_ANON_8_center_name', pyxb.binding.datatypes.string)
...
AnalysisFileType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CHECKLIST'), CTD_ANON_8, scope=AnalysisFileType))
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ANALYSIS_LINK'), common.LinkType, scope=CTD_ANON_2))
CTD_ANON_2._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(None, u'ANALYSIS_LINK')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_2._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_2._GroupModel, min_occurs=1L, max_occurs=None)



AnalysisType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SAMPLE_REF'), CTD_ANON_, scope=AnalysisType, documentation=u'One of more samples associated with the\n                        analysis.'))

AnalysisType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ANALYSIS_ATTRIBUTES'), CTD_ANON_7, scope=AnalysisType, documentation=u'Properties and attributes of an analysis. These can be\n                        entered as free-form tag-value pairs.'))
...
AnalysisType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ANALYSIS_LINKS'), CTD_ANON_2, scope=AnalysisType, documentation=u' Links to resources related to this analysis.\n                    '))

AnalysisType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ANALYSIS_TYPE'), CTD_ANON_3, scope=AnalysisType, documentation=u'The type of the analysis. '))
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SEQUENCE_VARIATION'), common.ReferenceSequenceType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SEQUENCE_ANNOTATION'), CTD_ANON, scope=CTD_ANON_3, documentation=u'Annotated sequences. '))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'REFERENCE_ALIGNMENT'), common.ReferenceSequenceType, scope=CTD_ANON_3, documentation=u''))
CTD_ANON_3._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(None, u'REFERENCE_ALIGNMENT')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(None, u'SEQUENCE_VARIATION')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(None, u'SEQUENCE_ANNOTATION')), min_occurs=1, max_occurs=1)
    )
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ANALYSIS_ATTRIBUTE'), common.AttributeType, scope=CTD_ANON_7))
CTD_ANON_7._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(None, u'ANALYSIS_ATTRIBUTE')), min_occurs=1, max_occurs=1)
    )
