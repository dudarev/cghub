# experiment/raw/experiment.py
# PyXB bindings for NM:e92452c8d3e28a9e27abfc9994d2007779e7f4c9
# Generated 2012-05-31 11:57:41.608432 by PyXB version 1.1.3
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __SEQUENCE_SPACE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'SEQUENCE_SPACE'), 'SEQUENCE_SPACE', '__AbsentNamespace0_CTD_ANON_3_SEQUENCE_SPACE', False)
    ...
    __BASE_CALLER = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'BASE_CALLER'), 'BASE_CALLER', '__AbsentNamespace0_CTD_ANON_3_BASE_CALLER', False)
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __NUMBER_OF_LEVELS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'NUMBER_OF_LEVELS'), 'NUMBER_OF_LEVELS', '__AbsentNamespace0_CTD_ANON_4_NUMBER_OF_LEVELS', False)
    ...
    __QUALITY_SCORER = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'QUALITY_SCORER'), 'QUALITY_SCORER', '__AbsentNamespace0_CTD_ANON_4_QUALITY_SCORER', False)
    ...
    __MULTIPLIER = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'MULTIPLIER'), 'MULTIPLIER', '__AbsentNamespace0_CTD_ANON_4_MULTIPLIER', False)
    ...
    __qtype = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'qtype'), 'qtype', '__AbsentNamespace0_CTD_ANON_4_qtype', STD_ANON_)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __EXPERIMENT_LINK = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_LINK'), 'EXPERIMENT_LINK', '__AbsentNamespace0_CTD_ANON_5_EXPERIMENT_LINK', True)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __EXPERIMENT_ATTRIBUTE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_ATTRIBUTE'), 'EXPERIMENT_ATTRIBUTE', '__AbsentNamespace0_CTD_ANON_6_EXPERIMENT_ATTRIBUTE', True)
...
ExperimentType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_LINKS'), CTD_ANON_5, scope=ExperimentType, documentation=u'\n\t\t\t  Links to resources related to this experiment or experiment set (publication, datasets, online databases).\n\t\t      '))

ExperimentType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_ATTRIBUTES'), CTD_ANON_6, scope=ExperimentType, documentation=u'\n                       Properties and attributes of the experiment.  These can be entered as free-form \n                       tag-value pairs. \n                    '))
...
ExperimentType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'STUDY_REF'), CTD_ANON, scope=ExperimentType, documentation=u'\n                        The STUDY_REF descriptor establishes the relationship of the experiment to the parent\n                        study.  This can either be the accession of an existing archived study record, or\n                        a reference to a new study record in the same submission (which does not yet have an\n                        accession).\n                      '))

ExperimentType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PLATFORM'), _com.PlatformType, scope=ExperimentType, documentation=u'\n                      The PLATFORM record selects which sequencing platform and platform-specific runtime parameters.  \n                      This will be determined by the Center.\n                    '))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LIBRARY_DESCRIPTOR'), _com.LibraryDescriptorType, scope=CTD_ANON_, documentation=u'\n                                  The LIBRARY_DESCRIPTOR specifies the origin of the material being sequenced and any treatments that the \n                                  material might have undergone that affect the sequencing result.  This specification is needed even if the platform\n                                  does not require a library construction step per se.\n                              '))

CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SPOT_DESCRIPTOR'), _com.SpotDescriptorType, scope=CTD_ANON_, documentation=u'\n                                  The SPOT_DESCRIPTOR specifies how to decode the individual reads of interest from the \n                                  monolithic spot sequence.  The spot descriptor contains aspects of the experimental design, \n                                  platform, and processing information.  There will be two methods of specification: one \n                                  will be an index into a table of typical decodings, the other being an exact specification.                                      \n                              '))

CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SAMPLE_DESCRIPTOR'), _com.SampleDescriptorType, scope=CTD_ANON_, documentation=u'\n                              Pick a sample to associate this experiment with.  \n                              The sample may be an individual or a pool, depending on how it is specified.\n                            '))

CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'GAP_DESCRIPTOR'), _com.GapDescriptorType, scope=CTD_ANON_, documentation=u' The GAP_DESCRIPTOR specifies how to place the\n                                    individual tags in the spot against a notinoal reference\n                                    sequence. This information is important to interpreting the\n                                    placement of spot tags in an assembly or alignment for the\n                                    purpose of detecting structural variations and other genomic\n                                    features. '))
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DIRECTIVES'), _com.SequencingDirectivesType, scope=CTD_ANON_2, documentation=u'\n                                        Processing directives tell the Sequence Read Archive how to treat the input data, if any treatment is requested.\n                                    '))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'BASE_CALLS'), CTD_ANON_3, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PIPELINE'), _com.PipelineType, scope=CTD_ANON_2, documentation=u'\n                                        Generic processing pipeline specification.\n                                    '))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'QUALITY_SCORES'), CTD_ANON_4, scope=CTD_ANON_2, documentation=u'\n                                        DEPRECATED.  THis is instead a  property of the run to load.  Basecalling software and version will be called out in\n                                        new branch PIPELINE.\n                                    '))
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SEQUENCE_SPACE'), STD_ANON, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'BASE_CALLER'), pyxb.binding.datatypes.string, scope=CTD_ANON_3, documentation=u'\n                                                    Name and version of the base or color calling software.\n                                                '))
CTD_ANON_3._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(None, u'SEQUENCE_SPACE')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(None, u'BASE_CALLER')), min_occurs=1L, max_occurs=1L)
    )
CTD_ANON_3._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_3._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'NUMBER_OF_LEVELS'), pyxb.binding.datatypes.int, scope=CTD_ANON_4, documentation=u'\n                                                    DEPRECATED.  Number of distinct values possible with this scoring system.\n                                                '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'QUALITY_SCORER'), pyxb.binding.datatypes.string, scope=CTD_ANON_4, documentation=u'\n                                                    Name and version of the quality scoring software.\n                                                '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'MULTIPLIER'), pyxb.binding.datatypes.double, scope=CTD_ANON_4, documentation=u'\n                                                    DEPRECATED.\n                                                '))
CTD_ANON_4._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(None, u'QUALITY_SCORER')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(None, u'NUMBER_OF_LEVELS')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(None, u'MULTIPLIER')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_4._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_4._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_LINK'), _com.LinkType, scope=CTD_ANON_5))
CTD_ANON_5._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_LINK')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_5._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_5._GroupModel, min_occurs=1L, max_occurs=None)



CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_ATTRIBUTE'), _com.AttributeType, scope=CTD_ANON_6))
CTD_ANON_6._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(None, u'EXPERIMENT_ATTRIBUTE')), min_occurs=1, max_occurs=1)
    )
