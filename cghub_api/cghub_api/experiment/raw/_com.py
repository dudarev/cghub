# experiment/raw/_com.py
# PyXB bindings for NM:1c06abdc99453cc1e399eecb45b4dd01ec9af52b
# Generated 2012-05-31 11:57:41.607988 by PyXB version 1.1.3
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:a8e68e8c-aafe-11e1-96ef-0026c7825912')
...
STD_ANON.simple_pool = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'simple pool', tag=u'simple_pool')
STD_ANON.multiplexed_samples = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'multiplexed samples', tag=u'multiplexed_samples')
STD_ANON.multiplexed_libraries = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'multiplexed libraries', tag=u'multiplexed_libraries')
STD_ANON.spiked_library = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'spiked library', tag=u'spiked_library')
...
STD_ANON_.leave_as_pool = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'leave_as_pool', tag=u'leave_as_pool')
STD_ANON_.submitter_demultiplexed = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'submitter_demultiplexed', tag=u'submitter_demultiplexed')
...
STD_ANON_2.start = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'start', tag=u'start')
STD_ANON_2.end = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'end', tag=u'end')
...
STD_ANON_3.PacBio_RS = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'PacBio RS', tag=u'PacBio_RS')
...
STD_ANON_4.innie = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'innie', tag=u'innie')
STD_ANON_4.outie = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'outie', tag=u'outie')
STD_ANON_4.normal = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'normal', tag=u'normal')
STD_ANON_4.anti_normal = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'anti-normal', tag=u'anti_normal')
...
STD_ANON_5.Application_Read = STD_ANON_5._CF_enumeration.addEnumeration(unicode_value=u'Application Read', tag=u'Application_Read')
STD_ANON_5.Technical_Read = STD_ANON_5._CF_enumeration.addEnumeration(unicode_value=u'Technical Read', tag=u'Technical_Read')
...
STD_ANON_6.Forward = STD_ANON_6._CF_enumeration.addEnumeration(unicode_value=u'Forward', tag=u'Forward')
STD_ANON_6.Reverse = STD_ANON_6._CF_enumeration.addEnumeration(unicode_value=u'Reverse', tag=u'Reverse')
STD_ANON_6.Adapter = STD_ANON_6._CF_enumeration.addEnumeration(unicode_value=u'Adapter', tag=u'Adapter')
STD_ANON_6.Primer = STD_ANON_6._CF_enumeration.addEnumeration(unicode_value=u'Primer', tag=u'Primer')
STD_ANON_6.Linker = STD_ANON_6._CF_enumeration.addEnumeration(unicode_value=u'Linker', tag=u'Linker')
STD_ANON_6.BarCode = STD_ANON_6._CF_enumeration.addEnumeration(unicode_value=u'BarCode', tag=u'BarCode')
...
STD_ANON_8.WGS = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'WGS', tag=u'WGS')
STD_ANON_8.WXS = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'WXS', tag=u'WXS')
STD_ANON_8.RNA_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'RNA-Seq', tag=u'RNA_Seq')
STD_ANON_8.WCS = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'WCS', tag=u'WCS')
STD_ANON_8.CLONE = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'CLONE', tag=u'CLONE')
STD_ANON_8.POOLCLONE = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'POOLCLONE', tag=u'POOLCLONE')
STD_ANON_8.AMPLICON = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'AMPLICON', tag=u'AMPLICON')
STD_ANON_8.CLONEEND = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'CLONEEND', tag=u'CLONEEND')
STD_ANON_8.FINISHING = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'FINISHING', tag=u'FINISHING')
STD_ANON_8.ChIP_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'ChIP-Seq', tag=u'ChIP_Seq')
STD_ANON_8.MNase_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'MNase-Seq', tag=u'MNase_Seq')
STD_ANON_8.DNase_Hypersensitivity = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'DNase-Hypersensitivity', tag=u'DNase_Hypersensitivity')
STD_ANON_8.Bisulfite_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'Bisulfite-Seq', tag=u'Bisulfite_Seq')
STD_ANON_8.EST = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'EST', tag=u'EST')
STD_ANON_8.FL_cDNA = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'FL-cDNA', tag=u'FL_cDNA')
STD_ANON_8.CTS = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'CTS', tag=u'CTS')
STD_ANON_8.MRE_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'MRE-Seq', tag=u'MRE_Seq')
STD_ANON_8.MeDIP_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'MeDIP-Seq', tag=u'MeDIP_Seq')
STD_ANON_8.MBD_Seq = STD_ANON_8._CF_enumeration.addEnumeration(unicode_value=u'MBD-Seq', tag=u'MBD_Seq')
...
STD_ANON_9.GENOMIC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'GENOMIC', tag=u'GENOMIC')
STD_ANON_9.TRANSCRIPTOMIC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'TRANSCRIPTOMIC', tag=u'TRANSCRIPTOMIC')
STD_ANON_9.METAGENOMIC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'METAGENOMIC', tag=u'METAGENOMIC')
STD_ANON_9.METATRANSCRIPTOMIC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'METATRANSCRIPTOMIC', tag=u'METATRANSCRIPTOMIC')
STD_ANON_9.NON_GENOMIC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'NON GENOMIC', tag=u'NON_GENOMIC')
STD_ANON_9.SYNTHETIC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'SYNTHETIC', tag=u'SYNTHETIC')
STD_ANON_9.VIRAL_RNA = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'VIRAL RNA', tag=u'VIRAL_RNA')
STD_ANON_9.OTHER = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'OTHER', tag=u'OTHER')
...
STD_ANON_10.AB_SOLiD_System = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD System', tag=u'AB_SOLiD_System')
STD_ANON_10.AB_SOLiD_System_2_0 = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD System 2.0', tag=u'AB_SOLiD_System_2_0')
STD_ANON_10.AB_SOLiD_System_3_0 = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD System 3.0', tag=u'AB_SOLiD_System_3_0')
STD_ANON_10.AB_SOLiD_System_3_Plus = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD System 3 Plus', tag=u'AB_SOLiD_System_3_Plus')
STD_ANON_10.AB_SOLiD_4_System = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD 4 System', tag=u'AB_SOLiD_4_System')
STD_ANON_10.AB_SOLiD_4hq_System = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD 4hq System', tag=u'AB_SOLiD_4hq_System')
STD_ANON_10.AB_SOLiD_PI_System = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD PI System', tag=u'AB_SOLiD_PI_System')
STD_ANON_10.AB_SOLiD_5500 = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD 5500', tag=u'AB_SOLiD_5500')
STD_ANON_10.AB_SOLiD_5500xl = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'AB SOLiD 5500xl', tag=u'AB_SOLiD_5500xl')
STD_ANON_10.unspecified = STD_ANON_10._CF_enumeration.addEnumeration(unicode_value=u'unspecified', tag=u'unspecified')
...
STD_ANON_11.RANDOM = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'RANDOM', tag=u'RANDOM')
STD_ANON_11.PCR = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'PCR', tag=u'PCR')
STD_ANON_11.RANDOM_PCR = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'RANDOM PCR', tag=u'RANDOM_PCR')
STD_ANON_11.RT_PCR = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'RT-PCR', tag=u'RT_PCR')
STD_ANON_11.HMPR = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'HMPR', tag=u'HMPR')
STD_ANON_11.MF = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'MF', tag=u'MF')
STD_ANON_11.CF_S = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'CF-S', tag=u'CF_S')
STD_ANON_11.CF_M = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'CF-M', tag=u'CF_M')
STD_ANON_11.CF_H = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'CF-H', tag=u'CF_H')
STD_ANON_11.CF_T = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'CF-T', tag=u'CF_T')
STD_ANON_11.MSLL = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'MSLL', tag=u'MSLL')
STD_ANON_11.cDNA = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'cDNA', tag=u'cDNA')
STD_ANON_11.ChIP = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'ChIP', tag=u'ChIP')
STD_ANON_11.MNase = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'MNase', tag=u'MNase')
STD_ANON_11.DNAse = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'DNAse', tag=u'DNAse')
STD_ANON_11.Hybrid_Selection = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'Hybrid Selection', tag=u'Hybrid_Selection')
STD_ANON_11.Reduced_Representation = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'Reduced Representation', tag=u'Reduced_Representation')
STD_ANON_11.Restriction_Digest = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'Restriction Digest', tag=u'Restriction_Digest')
STD_ANON_11.n5_methylcytidine_antibody = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'5-methylcytidine antibody', tag=u'n5_methylcytidine_antibody')
STD_ANON_11.MBD2_protein_methyl_CpG_binding_domain = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'MBD2 protein methyl-CpG binding domain', tag=u'MBD2_protein_methyl_CpG_binding_domain')
STD_ANON_11.CAGE = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'CAGE', tag=u'CAGE')
STD_ANON_11.RACE = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'RACE', tag=u'RACE')
STD_ANON_11.size_fractionation = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'size fractionation', tag=u'size_fractionation')
STD_ANON_11.other = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'other', tag=u'other')
STD_ANON_11.unspecified = STD_ANON_11._CF_enumeration.addEnumeration(unicode_value=u'unspecified', tag=u'unspecified')
...
STD_ANON_12.Helicos_HeliScope = STD_ANON_12._CF_enumeration.addEnumeration(unicode_value=u'Helicos HeliScope', tag=u'Helicos_HeliScope')
STD_ANON_12.unspecified = STD_ANON_12._CF_enumeration.addEnumeration(unicode_value=u'unspecified', tag=u'unspecified')
...
STD_ANON_13.n454_GS_FLX_Plus = STD_ANON_13._CF_enumeration.addEnumeration(unicode_value=u'454 GS FLX Plus', tag=u'n454_GS_FLX_Plus')
...
STD_ANON_14.STUDY = STD_ANON_14._CF_enumeration.addEnumeration(unicode_value=u'STUDY', tag=u'STUDY')
STD_ANON_14.SAMPLE = STD_ANON_14._CF_enumeration.addEnumeration(unicode_value=u'SAMPLE', tag=u'SAMPLE')
STD_ANON_14.ANALYSIS = STD_ANON_14._CF_enumeration.addEnumeration(unicode_value=u'ANALYSIS', tag=u'ANALYSIS')
STD_ANON_14.EXPERIMENT = STD_ANON_14._CF_enumeration.addEnumeration(unicode_value=u'EXPERIMENT', tag=u'EXPERIMENT')
STD_ANON_14.RUN = STD_ANON_14._CF_enumeration.addEnumeration(unicode_value=u'RUN', tag=u'RUN')
...
STD_ANON_15.n16S_rRNA = STD_ANON_15._CF_enumeration.addEnumeration(unicode_value=u'16S rRNA', tag=u'n16S_rRNA')
STD_ANON_15.exome = STD_ANON_15._CF_enumeration.addEnumeration(unicode_value=u'exome', tag=u'exome')
STD_ANON_15.other = STD_ANON_15._CF_enumeration.addEnumeration(unicode_value=u'other', tag=u'other')
...
STD_ANON_16.Complete_Genomics = STD_ANON_16._CF_enumeration.addEnumeration(unicode_value=u'Complete Genomics', tag=u'Complete_Genomics')
STD_ANON_16.unspecified = STD_ANON_16._CF_enumeration.addEnumeration(unicode_value=u'unspecified', tag=u'unspecified')
STD_ANON_16.none = STD_ANON_16._CF_enumeration.addEnumeration(unicode_value=u'none', tag=u'none')
...
STD_ANON_17.Illumina_Genome_Analyzer = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina Genome Analyzer', tag=u'Illumina_Genome_Analyzer')
STD_ANON_17.Illumina_Genome_Analyzer_II = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina Genome Analyzer II', tag=u'Illumina_Genome_Analyzer_II')
STD_ANON_17.Illumina_Genome_Analyzer_IIx = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina Genome Analyzer IIx', tag=u'Illumina_Genome_Analyzer_IIx')
STD_ANON_17.Illumina_HiSeq_2500 = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina HiSeq 2500', tag=u'Illumina_HiSeq_2500')
STD_ANON_17.Illumina_HiSeq_2000 = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina HiSeq 2000', tag=u'Illumina_HiSeq_2000')
STD_ANON_17.Illumina_HiSeq_1000 = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina HiSeq 1000', tag=u'Illumina_HiSeq_1000')
STD_ANON_17.Illumina_HiScanSQ = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina HiScanSQ', tag=u'Illumina_HiScanSQ')
STD_ANON_17.Illumina_MiSeq = STD_ANON_17._CF_enumeration.addEnumeration(unicode_value=u'Illumina MiSeq', tag=u'Illumina_MiSeq')
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __default_length = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'default_length'), 'default_length', '__SRA_common_CTD_ANON_default_length', pyxb.binding.datatypes.nonNegativeInteger)
    ...
    __base_coord = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'base_coord'), 'base_coord', '__SRA_common_CTD_ANON_base_coord', pyxb.binding.datatypes.nonNegativeInteger)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    __LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'LABEL'), 'LABEL', '__SRA_common_CTD_ANON__LABEL', False)
    ...
    __URL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'URL'), 'URL', '__SRA_common_CTD_ANON__URL', False)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __INSTRUMENT_MODEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), 'INSTRUMENT_MODEL', '__SRA_common_CTD_ANON_2_INSTRUMENT_MODEL', False)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __BASECALL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'BASECALL'), 'BASECALL', '__SRA_common_CTD_ANON_3_BASECALL', True)
    ...
    # Attribute default_length uses Python identifier default_length
    __default_length = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'default_length'), 'default_length', '__SRA_common_CTD_ANON_3_default_length', pyxb.binding.datatypes.nonNegativeInteger)
    
    default_length = property(__default_length.value, __default_length.set, None, u'\n                                                                Specify whether the spot should have a default length for this tag if the expected base cannot be matched.\n                                                            ')

    
    # Attribute base_coord uses Python identifier base_coord
    __base_coord = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'base_coord'), 'base_coord', '__SRA_common_CTD_ANON_3_base_coord', pyxb.binding.datatypes.nonNegativeInteger)
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __MEMBER = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'MEMBER'), 'MEMBER', '__SRA_common_CTD_ANON_4_MEMBER', True)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ADAPTER_SPEC = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ADAPTER_SPEC'), 'ADAPTER_SPEC', '__SRA_common_CTD_ANON_5_ADAPTER_SPEC', False)
    ...
    __READ_SPEC = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'READ_SPEC'), 'READ_SPEC', '__SRA_common_CTD_ANON_5_READ_SPEC', True)
    ...
    __NUMBER_OF_READS_PER_SPOT = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'NUMBER_OF_READS_PER_SPOT'), 'NUMBER_OF_READS_PER_SPOT', '__SRA_common_CTD_ANON_5_NUMBER_OF_READS_PER_SPOT', False)
    ...
    __SPOT_LENGTH = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'SPOT_LENGTH'), 'SPOT_LENGTH', '__SRA_common_CTD_ANON_5_SPOT_LENGTH', False)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __accession = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'accession'), 'accession', '__SRA_common_CTD_ANON_6_accession', pyxb.binding.datatypes.token)
    ...
    __label = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'label'), 'label', '__SRA_common_CTD_ANON_6_label', pyxb.binding.datatypes.string)
...
# Complex type CTD_ANON_7 with content type SIMPLE
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __read_group_tag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'read_group_tag'), 'read_group_tag', '__SRA_common_CTD_ANON_7_read_group_tag', pyxb.binding.datatypes.string)
    ...
    __min_match = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min_match'), 'min_match', '__SRA_common_CTD_ANON_7_min_match', pyxb.binding.datatypes.nonNegativeInteger)
    ...
    __match_edge = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'match_edge'), 'match_edge', '__SRA_common_CTD_ANON_7_match_edge', STD_ANON_2)
    ...
    __max_mismatch = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'max_mismatch'), 'max_mismatch', '__SRA_common_CTD_ANON_7_max_mismatch', pyxb.binding.datatypes.nonNegativeInteger)
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __PREV_STEP_INDEX = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'PREV_STEP_INDEX'), 'PREV_STEP_INDEX', '__SRA_common_CTD_ANON_8_PREV_STEP_INDEX', True)
    ...
    __NOTES = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'NOTES'), 'NOTES', '__SRA_common_CTD_ANON_8_NOTES', False)
    ...
    __STEP_INDEX = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'STEP_INDEX'), 'STEP_INDEX', '__SRA_common_CTD_ANON_8_STEP_INDEX', False)
    ...
    __PROGRAM = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'PROGRAM'), 'PROGRAM', '__SRA_common_CTD_ANON_8_PROGRAM', False)
    ...
    __VERSION = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'VERSION'), 'VERSION', '__SRA_common_CTD_ANON_8_VERSION', False)
    ...
    __section_name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'section_name'), 'section_name', '__SRA_common_CTD_ANON_8_section_name', pyxb.binding.datatypes.string)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __orientation = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'orientation'), 'orientation', '__SRA_common_CTD_ANON_9_orientation', STD_ANON_4)
...
class CTD_ANON_10 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __READ_LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'READ_LABEL'), 'READ_LABEL', '__SRA_common_CTD_ANON_10_READ_LABEL', False)
    ...
    __READ_TYPE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'READ_TYPE'), 'READ_TYPE', '__SRA_common_CTD_ANON_10_READ_TYPE', False)
    ...
    __EXPECTED_BASECALL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'EXPECTED_BASECALL'), 'EXPECTED_BASECALL', '__SRA_common_CTD_ANON_10_EXPECTED_BASECALL', False)
    ...
    __EXPECTED_BASECALL_TABLE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'EXPECTED_BASECALL_TABLE'), 'EXPECTED_BASECALL_TABLE', '__SRA_common_CTD_ANON_10_EXPECTED_BASECALL_TABLE', False)
    ...
    __RELATIVE_ORDER = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'RELATIVE_ORDER'), 'RELATIVE_ORDER', '__SRA_common_CTD_ANON_10_RELATIVE_ORDER', False)
    ...
    __BASE_COORD = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'BASE_COORD'), 'BASE_COORD', '__SRA_common_CTD_ANON_10_BASE_COORD', False)
    ...
    __READ_INDEX = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'READ_INDEX'), 'READ_INDEX', '__SRA_common_CTD_ANON_10_READ_INDEX', False)
    ...
    __CYCLE_COORD = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'CYCLE_COORD'), 'CYCLE_COORD', '__SRA_common_CTD_ANON_10_CYCLE_COORD', False)
    ...
    __READ_CLASS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'READ_CLASS'), 'READ_CLASS', '__SRA_common_CTD_ANON_10_READ_CLASS', False)
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute refname uses Python identifier refname
    __refname = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'refname'), 'refname', '__SRA_common_CTD_ANON_11_refname', pyxb.binding.datatypes.string)
    
    refname = property(__refname.value, __refname.set, None, u'A recognized name for the\n                                                 genome assembly.')

    
    # Attribute accession uses Python identifier accession
    __accession = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'accession'), 'accession', '__SRA_common_CTD_ANON_11_accession', pyxb.binding.datatypes.token)
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __MatePair = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'MatePair'), 'MatePair', '__SRA_common_CTD_ANON_12_MatePair', False)
    ...
    __PairedEnd = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'PairedEnd'), 'PairedEnd', '__SRA_common_CTD_ANON_12_PairedEnd', False)
    ...
    __Tandem = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'Tandem'), 'Tandem', '__SRA_common_CTD_ANON_12_Tandem', False)
...
class CTD_ANON_14 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __precedes_read_index = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'precedes_read_index'), 'precedes_read_index', '__SRA_common_CTD_ANON_14_precedes_read_index', pyxb.binding.datatypes.nonNegativeInteger)
    ...
    __follows_read_index = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'follows_read_index'), 'follows_read_index', '__SRA_common_CTD_ANON_14_follows_read_index', pyxb.binding.datatypes.nonNegativeInteger)
...
class CTD_ANON_15 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __URL_LINK = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'URL_LINK'), 'URL_LINK', '__SRA_common_CTD_ANON_15_URL_LINK', True)
    ...
    __DESCRIPTION = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'DESCRIPTION'), 'DESCRIPTION', '__SRA_common_CTD_ANON_15_DESCRIPTION', False)
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __statistic = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'statistic'), 'statistic', '__SRA_common_CTD_ANON_17_statistic', False)
    ...
    __histogram = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'histogram'), 'histogram', '__SRA_common_CTD_ANON_17_histogram', False)
    ...
    __interval = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'interval'), 'interval', '__SRA_common_CTD_ANON_17_interval', False)
    ...
    __link5 = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'link5'), 'link5', '__SRA_common_CTD_ANON_17_link5', pyxb.binding.datatypes.anySimpleType, unicode_default=u'NULL')
    ...
    __link3 = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'link3'), 'link3', '__SRA_common_CTD_ANON_17_link3', pyxb.binding.datatypes.anySimpleType, unicode_default=u'NULL')
...
class CTD_ANON_18 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element LABEL uses Python identifier LABEL
    __LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'LABEL'), 'LABEL', '__SRA_common_CTD_ANON_18_LABEL', False)
    ...
    # Element DB uses Python identifier DB
    __DB = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'DB'), 'DB', '__SRA_common_CTD_ANON_18_DB', False)
    ...
    __QUERY = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'QUERY'), 'QUERY', '__SRA_common_CTD_ANON_18_QUERY', False)
    ...
    # Element ID uses Python identifier ID
    __ID = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ID'), 'ID', '__SRA_common_CTD_ANON_18_ID', False)
...
class CTD_ANON_19 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element READ_LABEL uses Python identifier READ_LABEL
    __READ_LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'READ_LABEL'), 'READ_LABEL', '__SRA_common_CTD_ANON_19_READ_LABEL', True)
    ...
    # Attribute refname uses Python identifier refname
    __refname = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'refname'), 'refname', '__SRA_common_CTD_ANON_19_refname', pyxb.binding.datatypes.string)
    
    refname = property(__refname.value, __refname.set, None, u'\n                    Identifies a record by name that is known within the namespace defined by attribute "refcenter"\n                    Use this field when referencing an object for which an accession has not yet been issued.\n                ')

    
    # Attribute accession uses Python identifier accession
    __accession = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'accession'), 'accession', '__SRA_common_CTD_ANON_19_accession', pyxb.binding.datatypes.string)
    
    accession = property(__accession.value, __accession.set, None, u'\n                    Identifies a record by its accession.  The scope of resolution is the entire Archive.\n                ')

    
    # Attribute member_name uses Python identifier member_name
    __member_name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'member_name'), 'member_name', '__SRA_common_CTD_ANON_19_member_name', pyxb.binding.datatypes.string)
    ...
    __proportion = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'proportion'), 'proportion', '__SRA_common_CTD_ANON_19_proportion', pyxb.binding.datatypes.float)
    ...
    # Attribute refcenter uses Python identifier refcenter
    __refcenter = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'refcenter'), 'refcenter', '__SRA_common_CTD_ANON_19_refcenter', pyxb.binding.datatypes.string)
...
# Complex type CTD_ANON_20 with content type EMPTY
class CTD_ANON_20 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min_length = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min_length'), 'min_length', '__SRA_common_CTD_ANON_20_min_length', pyxb.binding.datatypes.integer, required=True)
    ...
    __max_length = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'max_length'), 'max_length', '__SRA_common_CTD_ANON_20_max_length', pyxb.binding.datatypes.integer, required=True)
...
class CTD_ANON_21 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __FLOW_COUNT = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'FLOW_COUNT'), 'FLOW_COUNT', '__SRA_common_CTD_ANON_21_FLOW_COUNT', False)
    ...
    # Element INSTRUMENT_MODEL uses Python identifier INSTRUMENT_MODEL
    __INSTRUMENT_MODEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), 'INSTRUMENT_MODEL', '__SRA_common_CTD_ANON_21_INSTRUMENT_MODEL', False)
    ...
    __FLOW_SEQUENCE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'FLOW_SEQUENCE'), 'FLOW_SEQUENCE', '__SRA_common_CTD_ANON_21_FLOW_SEQUENCE', False)
...
class CTD_ANON_22 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mean = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mean'), 'mean', '__SRA_common_CTD_ANON_22_mean', pyxb.binding.datatypes.float, required=True)
    
    mean = property(__mean.value, __mean.set, None, u' Mean length in base pairs of\n                                                  the interval.')

    
    # Attribute stdev uses Python identifier stdev
    __stdev = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'stdev'), 'stdev', '__SRA_common_CTD_ANON_22_stdev', pyxb.binding.datatypes.float, required=True)
...
# Complex type CTD_ANON_23 with content type SIMPLE
class CTD_ANON_23 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute read_group_tag uses Python identifier read_group_tag
    __read_group_tag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'read_group_tag'), 'read_group_tag', '__SRA_common_CTD_ANON_23_read_group_tag', pyxb.binding.datatypes.string)
...
class CTD_ANON_24 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __bin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'bin'), 'bin', '__SRA_common_CTD_ANON_24_bin', True)
...
class CTD_ANON_25 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element LABEL uses Python identifier LABEL
    __LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'LABEL'), 'LABEL', '__SRA_common_CTD_ANON_25_LABEL', False)
    ...
    # Element DB uses Python identifier DB
    __DB = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'DB'), 'DB', '__SRA_common_CTD_ANON_25_DB', False)
    ...
    # Element ID uses Python identifier ID
    __ID = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ID'), 'ID', '__SRA_common_CTD_ANON_25_ID', False)
    ...
    # Element URL uses Python identifier URL
    __URL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'URL'), 'URL', '__SRA_common_CTD_ANON_25_URL', False)
...
class CTD_ANON_26 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __dibase = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dibase'), 'dibase', '__SRA_common_CTD_ANON_26_dibase', pyxb.binding.datatypes.string)
...
class CTD_ANON_27 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __COLOR = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'COLOR'), 'COLOR', '__SRA_common_CTD_ANON_27_COLOR', True)
...
class CTD_ANON_28 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ktile = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ktile'), 'ktile', '__SRA_common_CTD_ANON_28_ktile', pyxb.binding.datatypes.positiveInteger, required=True)
    
    ktile = property(__ktile.value, __ktile.set, None, u' k-tile where k is the k-th bin ')

    
    # Attribute value uses Python identifier value_
    __value = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'value'), 'value_', '__SRA_common_CTD_ANON_28_value', pyxb.binding.datatypes.nonNegativeInteger, required=True)
...
class CTD_ANON_29 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __COLOR_MATRIX = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'COLOR_MATRIX'), 'COLOR_MATRIX', '__SRA_common_CTD_ANON_29_COLOR_MATRIX', False)
    ...
    __COLOR_MATRIX_CODE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'COLOR_MATRIX_CODE'), 'COLOR_MATRIX_CODE', '__SRA_common_CTD_ANON_29_COLOR_MATRIX_CODE', False)
...
class CTD_ANON_30 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __SINGLE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'SINGLE'), 'SINGLE', '__SRA_common_CTD_ANON_30_SINGLE', False)
    ...
    __PAIRED = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'PAIRED'), 'PAIRED', '__SRA_common_CTD_ANON_30_PAIRED', False)
...
class CTD_ANON_31 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element FLOW_COUNT uses Python identifier FLOW_COUNT
    __FLOW_COUNT = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'FLOW_COUNT'), 'FLOW_COUNT', '__SRA_common_CTD_ANON_31_FLOW_COUNT', False)
    ...
    # Element FLOW_SEQUENCE uses Python identifier FLOW_SEQUENCE
    __FLOW_SEQUENCE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'FLOW_SEQUENCE'), 'FLOW_SEQUENCE', '__SRA_common_CTD_ANON_31_FLOW_SEQUENCE', False)
    ...
    # Element INSTRUMENT_MODEL uses Python identifier INSTRUMENT_MODEL
    __INSTRUMENT_MODEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), 'INSTRUMENT_MODEL', '__SRA_common_CTD_ANON_31_INSTRUMENT_MODEL', False)
    ...
    __KEY_SEQUENCE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'KEY_SEQUENCE'), 'KEY_SEQUENCE', '__SRA_common_CTD_ANON_31_KEY_SEQUENCE', False)
...
class CTD_ANON_32 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element LABEL uses Python identifier LABEL
    __LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'LABEL'), 'LABEL', '__SRA_common_CTD_ANON_32_LABEL', False)
    ...
    # Element DB uses Python identifier DB
    __DB = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'DB'), 'DB', '__SRA_common_CTD_ANON_32_DB', False)
    ...
    # Element ID uses Python identifier ID
    __ID = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ID'), 'ID', '__SRA_common_CTD_ANON_32_ID', False)
    ...
    # Element URL uses Python identifier URL
    __URL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'URL'), 'URL', '__SRA_common_CTD_ANON_32_URL', False)
...
class CTD_ANON_33 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __GAP_TYPE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'GAP_TYPE'), 'GAP_TYPE', '__SRA_common_CTD_ANON_33_GAP_TYPE', False)
    ...
    __GAP_SPEC = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'GAP_SPEC'), 'GAP_SPEC', '__SRA_common_CTD_ANON_33_GAP_SPEC', False)
...
class CTD_ANON_34 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __NOMINAL_SDEV = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'NOMINAL_SDEV'), 'NOMINAL_SDEV', '__SRA_common_CTD_ANON_34_NOMINAL_SDEV', pyxb.binding.datatypes.double)
    
    NOMINAL_SDEV = property(__NOMINAL_SDEV.value, __NOMINAL_SDEV.set, None, u'\n                                ')

    
    # Attribute ORIENTATION uses Python identifier ORIENTATION
    __ORIENTATION = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ORIENTATION'), 'ORIENTATION', '__SRA_common_CTD_ANON_34_ORIENTATION', pyxb.binding.datatypes.string)
    ...
    __NOMINAL_LENGTH = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'NOMINAL_LENGTH'), 'NOMINAL_LENGTH', '__SRA_common_CTD_ANON_34_NOMINAL_LENGTH', pyxb.binding.datatypes.nonNegativeInteger)
...
class SraLinkType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __sra_object_type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sra_object_type'), 'sra_object_type', '__SRA_common_SraLinkType_sra_object_type', STD_ANON_14)
...
class CTD_ANON_35 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element LABEL uses Python identifier LABEL
    __LABEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'LABEL'), 'LABEL', '__SRA_common_CTD_ANON_35_LABEL', False)
    ...
    # Element URL uses Python identifier URL
    __URL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'URL'), 'URL', '__SRA_common_CTD_ANON_35_URL', False)
...
class CTD_ANON_38 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __LOCUS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'LOCUS'), 'LOCUS', '__SRA_common_CTD_ANON_38_LOCUS', True)
...
class CTD_ANON_39 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __CYCLE_SEQUENCE = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'CYCLE_SEQUENCE'), 'CYCLE_SEQUENCE', '__SRA_common_CTD_ANON_39_CYCLE_SEQUENCE', False)
    ...
    # Element SEQUENCE_LENGTH uses Python identifier SEQUENCE_LENGTH
    __SEQUENCE_LENGTH = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'SEQUENCE_LENGTH'), 'SEQUENCE_LENGTH', '__SRA_common_CTD_ANON_39_SEQUENCE_LENGTH', False)
    ...
    # Element CYCLE_COUNT uses Python identifier CYCLE_COUNT
    __CYCLE_COUNT = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'CYCLE_COUNT'), 'CYCLE_COUNT', '__SRA_common_CTD_ANON_39_CYCLE_COUNT', False)
    ...
    # Element INSTRUMENT_MODEL uses Python identifier INSTRUMENT_MODEL
    __INSTRUMENT_MODEL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), 'INSTRUMENT_MODEL', '__SRA_common_CTD_ANON_39_INSTRUMENT_MODEL', False)
...
class CTD_ANON_40 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __PROBE_SET = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'PROBE_SET'), 'PROBE_SET', '__SRA_common_CTD_ANON_40_PROBE_SET', False)
    ...
    __description = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'description'), 'description', '__SRA_common_CTD_ANON_40_description', pyxb.binding.datatypes.string)
    
    description = property(__description.value, __description.set, None, None)

    
    # Attribute locus_name uses Python identifier locus_name
    __locus_name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'locus_name'), 'locus_name', '__SRA_common_CTD_ANON_40_locus_name', STD_ANON_15)
...
PipelineType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PIPE_SECTION'), CTD_ANON_8, scope=PipelineType))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LABEL'), pyxb.binding.datatypes.string, scope=CTD_ANON_, documentation=u' Text label to display for the\n                                                 link. '))

CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'URL'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_, documentation=u' The internet service link\n                                                 (file:, http:, ftp:, etc). '))
CTD_ANON_._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(None, u'LABEL')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(None, u'URL')), min_occurs=1L, max_occurs=1L)
    )
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), STD_ANON_7, scope=CTD_ANON_2))
CTD_ANON_2._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL')), min_occurs=1L, max_occurs=1L)
    )
CTD_ANON_2._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_2._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'BASECALL'), CTD_ANON_7, scope=CTD_ANON_3, documentation=u"\n                                                                    Element's body contains a basecall, attribute provide description of this read meaning as well as matching rules.\n                                                                "))
CTD_ANON_3._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(None, u'BASECALL')), min_occurs=1, max_occurs=None)
    )
CTD_ANON_3._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_3._GroupModel, min_occurs=1L, max_occurs=1L)



CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'MEMBER'), CTD_ANON_19, scope=CTD_ANON_4))
CTD_ANON_4._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(None, u'MEMBER')), min_occurs=1L, max_occurs=None)
    )
CTD_ANON_4._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_4._GroupModel, min_occurs=1, max_occurs=1)



ReferenceSequenceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SEQUENCE'), CTD_ANON_6, scope=ReferenceSequenceType, documentation=u'Reference sequence details.'))
...
ReferenceAssemblyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CUSTOM'), CTD_ANON_15, scope=ReferenceAssemblyType, documentation=u'Other genome\n                                                 assembly.'))

ReferenceAssemblyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'STANDARD'), CTD_ANON_11, scope=ReferenceAssemblyType, documentation=u'A standard genome assembly.\n                                                 '))
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ADAPTER_SPEC'), pyxb.binding.datatypes.string, scope=CTD_ANON_5, documentation=u'\n                                        Some technologies will require knowledge of the sequencing adapter or the last base of the adapter in order to decode the spot.\n                                    '))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'READ_SPEC'), CTD_ANON_10, scope=CTD_ANON_5))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'NUMBER_OF_READS_PER_SPOT'), pyxb.binding.datatypes.unsignedInt, scope=CTD_ANON_5, documentation=u'\n                                        DEPRECATED.  Number of tags (reads) per spot.\n                                    '))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SPOT_LENGTH'), pyxb.binding.datatypes.nonNegativeInteger, scope=CTD_ANON_5, documentation=u'\n                                        Expected number of base calls or cycles per spot (raw sequence length including all application and technical tags and mate pairs)\n                                    '))
CTD_ANON_5._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(None, u'NUMBER_OF_READS_PER_SPOT')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(None, u'SPOT_LENGTH')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(None, u'ADAPTER_SPEC')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(None, u'READ_SPEC')), min_occurs=1L, max_occurs=None)
    )
CTD_ANON_5._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_5._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PREV_STEP_INDEX'), pyxb.binding.datatypes.string, nillable=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_8, documentation=u'\n                                    STEP_INDEX of the previous step in the workflow.  Set toNIL if the first pipe section.\n                                '))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'NOTES'), pyxb.binding.datatypes.string, scope=CTD_ANON_8, documentation=u'\n                                    Notes about the program or process for primary analysis. \n                                '))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'STEP_INDEX'), pyxb.binding.datatypes.string, scope=CTD_ANON_8, documentation=u'\n                                    Lexically ordered  value that allows for the pipe section to be hierarchically ordered.  The float primitive data type is\n                                    used to allow for pipe sections to be inserted later on.\n                                '))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PROGRAM'), pyxb.binding.datatypes.string, scope=CTD_ANON_8, documentation=u'\n                                    Name of the program or process for primary analysis.   This may include a test or condition\n                                    that leads to branching in the workflow.\n                                '))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'VERSION'), pyxb.binding.datatypes.string, scope=CTD_ANON_8, documentation=u'\n                                    Version of the program or process for primary analysis. \n                                '))
CTD_ANON_8._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(None, u'STEP_INDEX')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(None, u'PREV_STEP_INDEX')), min_occurs=1L, max_occurs=None),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(None, u'PROGRAM')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(None, u'VERSION')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(None, u'NOTES')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_8._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_8._GroupModel, min_occurs=1, max_occurs=1)



PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ION_TORRENT'), CTD_ANON_2, scope=PlatformType, documentation=u'\n                    '))

PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ILLUMINA'), CTD_ANON_39, scope=PlatformType, documentation=u'\n                            Illumina is 4-channel flowgram with 1-to-1 mapping between basecalls and flows\n                        '))

PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ABI_SOLID'), CTD_ANON_29, scope=PlatformType, documentation=u'\n                            ABI is 4-channel flowgram with 1-to-1 mapping between basecalls and flows\n                        '))

PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'HELICOS'), CTD_ANON_21, scope=PlatformType, documentation=u'\n                            Helicos is similar to 454 technology - uses 1-color sequential flows   \n                        '))

PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LS454'), CTD_ANON_31, scope=PlatformType, documentation=u'\n                            454 technology use 1-color sequential flows \n                        '))

PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'COMPLETE_GENOMICS'), CTD_ANON_37, scope=PlatformType, documentation=u'\n                            Placeholder for CompleteGenomics platform type.   At present there is no instrument model.\n                        '))

PlatformType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PACBIO_SMRT'), CTD_ANON_41, scope=PlatformType, documentation=u'\n                            Placeholder for PacificBiosciences platform type.   At present there is no instrument model.\n                        '))
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'READ_LABEL'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation=u'READ_LABEL is a name for this tag, and can be used to on output to determine read name, for example F or R.'))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'READ_TYPE'), STD_ANON_6, scope=CTD_ANON_10))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EXPECTED_BASECALL'), CTD_ANON, scope=CTD_ANON_10, documentation=u'\n                                                        An expected basecall for a current read. Read will be zero-length if basecall is not present.\n                                                        Users of this facility should start migrating to EXPECTED_BASECALL_TABLE, as this field\n                                                        will be phased out.\n                                                    '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EXPECTED_BASECALL_TABLE'), CTD_ANON_3, scope=CTD_ANON_10, documentation=u'\n                                                        A set of choices of expected basecalls for a current read. Read will be zero-length if none is found.\n                                                    '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'RELATIVE_ORDER'), CTD_ANON_14, scope=CTD_ANON_10, documentation=u'\n                                                        The read is located beginning at the offset or cycle relative to another read.  \n                                                        This choice is appropriate for example when specifying a read\n                                                        that follows a variable length expected sequence(s).\n                                                    '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'BASE_COORD'), pyxb.binding.datatypes.integer, scope=CTD_ANON_10, documentation=u'\n                                                        The location of the read start in terms of base count (1 is beginning of spot).\n                                                    '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'READ_INDEX'), pyxb.binding.datatypes.nonNegativeInteger, scope=CTD_ANON_10, documentation=u'READ_INDEX starts at 0 and is incrementally increased for each sequential READ_SPEC within a SPOT_DECODE_SPEC'))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CYCLE_COORD'), pyxb.binding.datatypes.integer, scope=CTD_ANON_10, documentation=u'\n                                                        The location of the read start in terms of cycle count (1 is beginning of spot).\n                                                    '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'READ_CLASS'), STD_ANON_5, scope=CTD_ANON_10))
CTD_ANON_10._GroupModel_ = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'RELATIVE_ORDER')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'BASE_COORD')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'CYCLE_COORD')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'EXPECTED_BASECALL')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'EXPECTED_BASECALL_TABLE')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_10._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'READ_INDEX')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'READ_LABEL')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'READ_CLASS')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'READ_TYPE')), min_occurs=1, max_occurs=1),
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'MatePair'), CTD_ANON_9, scope=CTD_ANON_12, documentation=u' Mated tags with predicted separation and orientation. '))

CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PairedEnd'), CTD_ANON_16, scope=CTD_ANON_12, documentation=u' Mated tags sequenced from two ends\n                                                of a physical extent of genomic material. \n                                            '))

CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Tandem'), CTD_ANON_13, scope=CTD_ANON_12, documentation=u' Tandem gaps between ligands. '))
CTD_ANON_12._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(None, u'Tandem')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(None, u'MatePair')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(None, u'PairedEnd')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_12._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_12._GroupModel, min_occurs=1, max_occurs=1)



SampleDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'POOL'), CTD_ANON_4, scope=SampleDescriptorType, documentation=u'\n                        Identifies a list of group/pool/multiplex sample members.  This implies that\n                        this sample record is a group, pool, or multiplex, but is continues to receive\n                        its own accession and can be referenced by an experiment.  By default if\n                        no match to any of the listed members can be determined, then the default\n                        sampel reference is used.\n                    '))
...
CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'URL_LINK'), CTD_ANON_, scope=CTD_ANON_15, documentation=u'A link to the genome\n                                                 assembly.'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DESCRIPTION'), pyxb.binding.datatypes.string, scope=CTD_ANON_15, documentation=u'Description of the genome\n                                                 assembly.'))
CTD_ANON_15._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(None, u'DESCRIPTION')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(None, u'URL_LINK')), min_occurs=1, max_occurs=None)
    )
CTD_ANON_15._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_15._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'statistic'), CTD_ANON_22, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'histogram'), CTD_ANON_24, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'interval'), CTD_ANON_20, scope=CTD_ANON_17))
CTD_ANON_17._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(None, u'interval')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(None, u'statistic')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(None, u'histogram')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_17._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_17._GroupModel, min_occurs=1, max_occurs=1)



SpotDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SPOT_DECODE_SPEC'), CTD_ANON_5, scope=SpotDescriptorType))
...
GapDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'GAP'), CTD_ANON_33, scope=GapDescriptorType))
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LABEL'), pyxb.binding.datatypes.string, scope=CTD_ANON_18, documentation=u'\n                                    How to label the link.\n                                '))

CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DB'), pyxb.binding.datatypes.string, scope=CTD_ANON_18, documentation=u'\n                                    NCBI controlled vocabulary of permitted cross references.  Please see http://www.ncbi.nlm.nih.gov/entrez/eutils/einfo.fcgi? .\n                                '))

CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'QUERY'), pyxb.binding.datatypes.string, scope=CTD_ANON_18, documentation=u'\n                                        Accession string meaningful to the NCBI Entrez system.\n                                    '))

CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ID'), pyxb.binding.datatypes.nonNegativeInteger, scope=CTD_ANON_18, documentation=u'\n                                        Numeric record id meaningful to the NCBI Entrez system.\n                                    '))
CTD_ANON_18._GroupModel_ = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(None, u'ID')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(None, u'QUERY')), min_occurs=1L, max_occurs=1L)
    )
CTD_ANON_18._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(None, u'DB')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_18._GroupModel_, min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(None, u'LABEL')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_18._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_18._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'READ_LABEL'), CTD_ANON_23, scope=CTD_ANON_19))
CTD_ANON_19._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(None, u'READ_LABEL')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_19._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_19._GroupModel, min_occurs=0L, max_occurs=None)



CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'FLOW_COUNT'), pyxb.binding.datatypes.positiveInteger, scope=CTD_ANON_21, documentation=u'\n                                        The number of flows of challenge bases.  This is a constraint on maximum read length, but not equivalent. \n                                        This is optional in the schema now but will be required by business rules and future schema versions.\n                                    '))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), STD_ANON_12, scope=CTD_ANON_21))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'FLOW_SEQUENCE'), pyxb.binding.datatypes.string, scope=CTD_ANON_21, documentation=u'\n                                        The fixed sequence of challenge bases that flow across the flowcell. \n                                        This is optional in the schema now but will be required by business rules and future schema versions.\n                                    '))
CTD_ANON_21._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(None, u'FLOW_SEQUENCE')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(None, u'FLOW_COUNT')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_21._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_21._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_24._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'bin'), CTD_ANON_28, scope=CTD_ANON_24))
CTD_ANON_24._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(None, u'bin')), min_occurs=1L, max_occurs=None)
    )
CTD_ANON_24._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_24._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_25._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LABEL'), pyxb.binding.datatypes.string, scope=CTD_ANON_25, documentation=u'A textual description of the cross-reference.\n                            '))

CTD_ANON_25._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DB'), pyxb.binding.datatypes.string, scope=CTD_ANON_25, documentation=u'DDBJ controlled vocabulary of permitted cross references.\n                            '))

CTD_ANON_25._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ID'), pyxb.binding.datatypes.string, scope=CTD_ANON_25, documentation=u'Accession in the referenced database.\n                            '))

CTD_ANON_25._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'URL'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_25, documentation=u'An URL to the cross-references accession.\n                            '))
CTD_ANON_25._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(None, u'DB')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(None, u'ID')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(None, u'URL')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(None, u'LABEL')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_25._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_25._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'COLOR'), CTD_ANON_26, scope=CTD_ANON_27))
CTD_ANON_27._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(None, u'COLOR')), min_occurs=1L, max_occurs=None)
    )
CTD_ANON_27._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_27._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'COLOR_MATRIX'), CTD_ANON_27, scope=CTD_ANON_29, documentation=u' DEPRECATED. '))

CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CYCLE_COUNT'), pyxb.binding.datatypes.positiveInteger, scope=CTD_ANON_29, documentation=u'\n                                        DEPRECATED.  Use SEQUENCE_LENGTH instead.\n                                    '))

CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SEQUENCE_LENGTH'), pyxb.binding.datatypes.positiveInteger, scope=CTD_ANON_29, documentation=u'\n                                        The fixed number of bases expected in each raw sequence, including both mate pairs and any technical reads.\n                                        This is optional in the schema now but will be required by business rules and future schema versions.\n                                    '))

CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), STD_ANON_10, scope=CTD_ANON_29))

CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'COLOR_MATRIX_CODE'), pyxb.binding.datatypes.string, scope=CTD_ANON_29, documentation=u' DEPRECATED. '))
CTD_ANON_29._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_29._UseForTag(pyxb.namespace.ExpandedName(None, u'COLOR_MATRIX')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_29._UseForTag(pyxb.namespace.ExpandedName(None, u'COLOR_MATRIX_CODE')), min_occurs=0L, max_occurs=1L),
...
LibraryDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LIBRARY_SELECTION'), STD_ANON_11, scope=LibraryDescriptorType, documentation=u'\n                      Whether any method was used to select for or against, enrich, or screen \n                      the material being sequenced.     \n                  '))
...
LibraryDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LIBRARY_STRATEGY'), STD_ANON_8, scope=LibraryDescriptorType, documentation=u'\n                      Sequencing technique intended for this library.\n                  '))

LibraryDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LIBRARY_LAYOUT'), CTD_ANON_30, scope=LibraryDescriptorType, documentation=u'\n                      LIBRARY_LAYOUT specifies whether to expect single, paired, or other configuration of reads.  \n                      In the case of paired reads, information about the relative distance and orientation is specified.\n                  '))
...
LibraryDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LIBRARY_SOURCE'), STD_ANON_9, scope=LibraryDescriptorType, documentation=u'\n                      The LIBRARY_SOURCE specifies the type of source material that is being sequenced.\n                  '))

LibraryDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'POOLING_STRATEGY'), STD_ANON, scope=LibraryDescriptorType, documentation=u'\n                      The optional pooling strategy indicates how the library or libraries are organized if multiple samples are involved.\n                  '))

LibraryDescriptorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'TARGETED_LOCI'), CTD_ANON_38, scope=LibraryDescriptorType))
...
CTD_ANON_30._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SINGLE'), CTD_ANON_36, scope=CTD_ANON_30))

CTD_ANON_30._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PAIRED'), CTD_ANON_34, scope=CTD_ANON_30))
CTD_ANON_30._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_30._UseForTag(pyxb.namespace.ExpandedName(None, u'SINGLE')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_30._UseForTag(pyxb.namespace.ExpandedName(None, u'PAIRED')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_30._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_30._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'FLOW_COUNT'), pyxb.binding.datatypes.positiveInteger, scope=CTD_ANON_31, documentation=u'\n                                        The number of flows of challenge bases.  This is a constraint on maximum read length, but not equivalent.\n                                        This is optional in the schema now but will be required by business rules and future schema versions.\n                                    '))

CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'FLOW_SEQUENCE'), pyxb.binding.datatypes.string, scope=CTD_ANON_31, documentation=u'\n                                        The fixed sequence of challenge bases that flow across the picotiter plate.  \n                                        This is optional in the schema now but will be required by business rules and future schema versions.\n                                    '))

CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), STD_ANON_13, scope=CTD_ANON_31))

CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'KEY_SEQUENCE'), pyxb.binding.datatypes.string, scope=CTD_ANON_31, documentation=u'\n                                        The first bases that are expected to be produced by the challenge bases.  \n                                        This is optional in the schema now but will be required by business rules and future schema versions.\n                                    '))
CTD_ANON_31._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(None, u'KEY_SEQUENCE')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(None, u'FLOW_SEQUENCE')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(None, u'FLOW_COUNT')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_31._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_31._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_32._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LABEL'), pyxb.binding.datatypes.string, scope=CTD_ANON_32, documentation=u'A textual description of the cross-reference.\n                            '))

CTD_ANON_32._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DB'), pyxb.binding.datatypes.string, scope=CTD_ANON_32, documentation=u'\n                                EBI ENA controlled vocabulary of permitted\n                                cross references.\n                            '))

CTD_ANON_32._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ID'), pyxb.binding.datatypes.string, scope=CTD_ANON_32, documentation=u' Accession in the referenced\n                                database.'))

CTD_ANON_32._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'URL'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_32, documentation=u'An URL to the cross-references accession.\n                            '))
CTD_ANON_32._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_32._UseForTag(pyxb.namespace.ExpandedName(None, u'DB')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_32._UseForTag(pyxb.namespace.ExpandedName(None, u'ID')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_32._UseForTag(pyxb.namespace.ExpandedName(None, u'URL')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_32._UseForTag(pyxb.namespace.ExpandedName(None, u'LABEL')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_32._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_32._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_33._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'GAP_TYPE'), CTD_ANON_12, scope=CTD_ANON_33, documentation=u' Specifies the gap type and parameters. '))

CTD_ANON_33._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'GAP_SPEC'), CTD_ANON_17, scope=CTD_ANON_33))
CTD_ANON_33._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_33._UseForTag(pyxb.namespace.ExpandedName(None, u'GAP_TYPE')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_33._UseForTag(pyxb.namespace.ExpandedName(None, u'GAP_SPEC')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_33._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_33._GroupModel, min_occurs=1, max_occurs=1)



SequencingDirectivesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SAMPLE_DEMUX_DIRECTIVE'), STD_ANON_, scope=SequencingDirectivesType, documentation=u'\n                        Tells the Archive who will execute the sample demultiplexing operation..\n                    '))
...
CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LABEL'), pyxb.binding.datatypes.string, scope=CTD_ANON_35, documentation=u'\n                                    Text label to display for the link.\n                                '))

CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'URL'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_35, documentation=u'\n                                    The internet service link (file:, http:, ftp:, etc).\n                                '))
CTD_ANON_35._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_35._UseForTag(pyxb.namespace.ExpandedName(None, u'LABEL')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_35._UseForTag(pyxb.namespace.ExpandedName(None, u'URL')), min_occurs=1L, max_occurs=1L)
    )
...
LinkType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ENTREZ_LINK'), CTD_ANON_18, scope=LinkType))

LinkType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'URL_LINK'), CTD_ANON_35, scope=LinkType))

LinkType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ENA_LINK'), CTD_ANON_32, scope=LinkType))

LinkType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DDBJ_LINK'), CTD_ANON_25, scope=LinkType))
...
CTD_ANON_37._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), STD_ANON_16, scope=CTD_ANON_37))
...
CTD_ANON_38._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LOCUS'), CTD_ANON_40, scope=CTD_ANON_38))
CTD_ANON_38._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_38._UseForTag(pyxb.namespace.ExpandedName(None, u'LOCUS')), min_occurs=1L, max_occurs=None)
    )
CTD_ANON_38._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_38._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_39._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CYCLE_SEQUENCE'), pyxb.binding.datatypes.string, scope=CTD_ANON_39, documentation=u'\n                                        DEPRECATED.\n                                    '))

CTD_ANON_39._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SEQUENCE_LENGTH'), pyxb.binding.datatypes.positiveInteger, scope=CTD_ANON_39, documentation=u'\n                                        The fixed number of bases expected in each raw sequence, including both mate pairs and any technical reads.\n                                    '))

CTD_ANON_39._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CYCLE_COUNT'), pyxb.binding.datatypes.positiveInteger, scope=CTD_ANON_39, documentation=u'\n                                        DEPRECATED, use SEQUENCE_LENGTH instead.  The fixed number of bases  in each raw sequence, including both mate pairs and any technical reads.\n                                    '))

CTD_ANON_39._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL'), STD_ANON_17, scope=CTD_ANON_39))
CTD_ANON_39._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_39._UseForTag(pyxb.namespace.ExpandedName(None, u'INSTRUMENT_MODEL')), min_occurs=1L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_39._UseForTag(pyxb.namespace.ExpandedName(None, u'CYCLE_SEQUENCE')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_39._UseForTag(pyxb.namespace.ExpandedName(None, u'CYCLE_COUNT')), min_occurs=0L, max_occurs=1L),
    pyxb.binding.content.ParticleModel(CTD_ANON_39._UseForTag(pyxb.namespace.ExpandedName(None, u'SEQUENCE_LENGTH')), min_occurs=0L, max_occurs=1L)
    )
CTD_ANON_39._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_39._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_40._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PROBE_SET'), XRefType, scope=CTD_ANON_40, documentation=u'\n                                              Reference to an archived primer or probe set.  Example:  dbProbe\n                                          '))
CTD_ANON_40._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_40._UseForTag(pyxb.namespace.ExpandedName(None, u'PROBE_SET')), min_occurs=1, max_occurs=1)
    )
